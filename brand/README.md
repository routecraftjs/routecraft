...
It is intentionally a self-contained HTML file (Tailwind via CDN, Google Fonts)
so it renders anywhere with no build step and survives independently of the
docs app.

## Related

- Social post templates that apply this brand language live in
  [`apps/routecraft.dev/post-templates/`](../apps/routecraft.dev/post-templates/).
</content>
</invoke>
