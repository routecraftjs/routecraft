...
![A tool call falling through four stacked gates in order: input, policy, identity and declared intent. The policy gate diverts a call whose recipient is outside the company domain. What survives all four reaches your logic.](https://routecraft.dev/images/figures/four-gates.png)
