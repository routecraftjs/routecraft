...
Write TypeScript capabilities and let AI agents use them to get real work done.
...
* **Secure by design:** Agents can only execute the specific capabilities you expose. No arbitrary filesystem access, no unchecked shell commands. You define the boundary.
