...
function EmptyState() {
  return (
    <div className="mt-16 border border-dashed border-ink/30 p-12 text-center dark:border-paper/30">
      <h2 className="font-editorial text-[1.5rem] tracking-[-0.01em] text-ink dark:text-paper">
        No posts yet.
      </h2>
      <p className="mt-3 font-editorial text-[1rem] text-ink/65 italic dark:text-paper/65">
...
function SubscribeCallout() {
  return (
    <section className="mt-24 border border-ink/15 bg-paper-deep/30 p-8 sm:p-12 dark:border-paper/15 dark:bg-ink-soft/30">
      <div className="grid grid-cols-1 items-center gap-8 lg:grid-cols-[2fr_1fr]">
        <div>
          ...
          <h2 className="mt-4 font-editorial text-[clamp(1.75rem,3vw,2.25rem)] leading-[1.1] tracking-[-0.015em] text-ink dark:text-paper">
            A code-first automation framework{' '}
            <span className="text-cobalt-500 italic">for TypeScript.</span>
          </h2>
          <p className="mt-4 max-w-xl text-[1rem] leading-[1.65] text-ink/70 dark:text-paper/70">
        ...
        <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 border border-ink/30 px-5 py-3 font-mono text-[0.7rem] tracking-[0.22em] text-ink uppercase transition hover:border-cobalt-500 hover:text-cobalt-500 dark:border-paper/30 dark:text-paper dark:hover:border-cobalt-300 dark:hover:text-cobalt-300"
          >
