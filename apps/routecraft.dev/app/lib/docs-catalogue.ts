...
// app/content/docs/_data/, inside the tree the release freeze pins to the
// released tag, and reach the components through the modules generated from
// there by scripts/generate-docs-catalogue.
//
