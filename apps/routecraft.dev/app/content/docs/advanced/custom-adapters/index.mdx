...
```ts skip="fragment: queue is illustrative"
...
```ts skip="fragment: storage is illustrative"
...
```ts skip="fragment: InputType, OutputType are illustrative"
...
```ts skip="fragment: MyQueueOptions, MyQueueAdapter are illustrative"
...
```ts skip="fragment: MyQueueOptions, MyQueueSourceAdapter, MyQueueDestinationAdapter are illustrative"
export function myQueue(options: MyQueueOptions) {
...
```ts skip="fragment: myQueue is illustrative"
...
```ts skip="fragment: MyOptions are illustrative"
...
```ts skip="fragment: MyOptions, MY_OPTIONS are illustrative"
