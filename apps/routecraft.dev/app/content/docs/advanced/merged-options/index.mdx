...
```ts skip="fragment: MyAdapterOptions is illustrative"
...
```ts skip="fragment: MyAdapterOptions, MY_ADAPTER_OPTIONS are illustrative"
...
```ts skip="fragment: myAdapterPlugin, MY_ADAPTER_OPTIONS are illustrative"
...
<QuickLink title="Configuration" icon="presets" href="/docs/reference/configuration" description="Full CraftConfig reference including cron and direct fields." />

<QuickLink title="Creating adapters" icon="plugins" href="/docs/advanced/custom-adapters" description="Build your own source, destination, enricher, or processor adapter." />

<QuickLink title="Plugins reference" icon="presets" href="/docs/reference/plugins" description="Full API for built-in plugin options." />
