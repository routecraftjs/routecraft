...
export default craft()
  .id("send-email")
  .input({ body: z.object({ recipient: z.string(), subject: z.string() }) })
...
```ts skip="fragment: mapCalendarEvents, eventSchema, googleCalendar are illustrative"
...
```ts skip="fragment: fetchNewOrders, fulfillOrder are illustrative"
...
<QuickLink title="Operations reference" icon="plugins" href="/docs/reference/operations" description="Full API: all operations with signatures and examples." />
