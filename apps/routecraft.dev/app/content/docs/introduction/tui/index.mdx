...
<QuickLink title="Monitoring" icon="presets" href="/docs/introduction/monitoring" description="Logging, events, and the telemetry plugin." />

<QuickLink title="CLI reference" icon="installation" href="/docs/reference/cli" description="All craft commands and options." />
