...
For all flags and options, see [CLI -- create](/docs/reference/cli#project-scaffolding).

### Start from the agent harness
...
It pulls the template's `main` branch (templates carry no tags). Its own
[README](https://github.com/routecraftjs/craft-harness) covers what each capability does,
which of them stay dormant until you configure them, and how the generated API key secures
every surface the harness exposes.
