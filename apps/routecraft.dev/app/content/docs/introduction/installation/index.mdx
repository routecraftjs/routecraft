...
It pulls the template's `main` branch (templates carry no tags) and boots with one key set.
The repository's own README covers what each capability does and which of them stay dormant
until you configure them: <https://github.com/routecraftjs/craft-harness>.
