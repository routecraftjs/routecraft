...
```ts skip="fragment: normalise, destination are illustrative"
craft()
  .id('process-order')
...
<QuickLink title="Operations reference" icon="presets" href="/docs/reference/operations" description="Full API: all operations with signatures, options, and examples." />
