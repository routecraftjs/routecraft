...
<QuickLink title="CLI reference" icon="installation" href="/docs/reference/cli" description="craft commands and options." />
...
<QuickLink title="Installation" icon="installation" href="/docs/introduction/installation" description="System requirements and project setup." />
