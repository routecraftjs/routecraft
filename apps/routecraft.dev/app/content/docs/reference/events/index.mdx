...
| `route:agent:tool:refused` | A tool's guard rejected a call the model made, on a tool it was allowed to attempt | `{ routeId, exchangeId, correlationId, toolCallId, toolName, rc? }` |
