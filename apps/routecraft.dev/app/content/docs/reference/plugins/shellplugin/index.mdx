...
| --- | --- | --- | --- | --- |
| `isolation` | `"none" \| "unshare" \| "docker"` | `unshare` | No | Isolation tier for calls that do not choose one |
| `timeout` | `Duration` | none | No | How long before a command and its children are killed, for calls that set none |
