...
```ts skip="fragment: ctx, widgets are illustrative"
...
{
  "items": [
    { "agent": "max", "session": "feature-login", "owner": "jaco", "cwd": "/work/eywa", "title": "Feature login", "turn": "idle", "inbox": 0, "background": 1, "parked": true, "messages": 14, "turns": 6, "updatedAt": "2026-09-04T21:40:11.522Z" }
  ]
}
```
...
```ts skip="fragment: mailHealth is illustrative"
export const craftConfig = defineConfig({
...
```ts skip="fragment: mailHealth are illustrative"
