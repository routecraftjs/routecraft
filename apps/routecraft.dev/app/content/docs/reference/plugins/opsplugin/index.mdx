...
{
  "items": [
    { "agent": "max", "session": "feature-login", "startedBy": "jaco", "turn": "idle", "inbox": 0, "background": 1, "parked": true, "messages": 14, "turns": 6, "updatedAt": "2026-09-04T21:40:11.522Z" }
  ]
}
```
