...
- **The suspension sweeper's in-flight sweep is abandoned.** Records it had
  claimed are not lost: the claim is a lease, and the next process to run
  the sweep picks them up once it expires.
