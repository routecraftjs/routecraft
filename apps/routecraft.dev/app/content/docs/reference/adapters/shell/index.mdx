...
### What `unshare` guarantees \{#what-unshare-guarantees}
...
### What `unshare` does not guarantee \{#what-unshare-does-not-guarantee}
...
### What `docker` guarantees \{#what-docker-guarantees}
...
### What `docker` does not guarantee \{#what-docker-does-not-guarantee}
