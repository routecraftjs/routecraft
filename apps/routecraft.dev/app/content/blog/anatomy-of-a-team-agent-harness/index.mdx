...
The team answer has to be asynchronous, and it starts with knowing *who* to ask. That is a skill in its own right. The agent works out who owns the decision, asks that person on the right channel, then defers the work with its full context intact and picks it up when the answer arrives. Forty seconds or Thursday, it makes no difference. Ask the right person, get the answer, carry on.
