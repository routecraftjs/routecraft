import type { DeferralStore } from "../../src/index.ts";

// Shared with the ecosystem suites; core's consumers import through here.
export { asDeferred, deferring } from "@routecraft/testing";
 ...
 * added to `DeferralStore` reaches every fake without editing it; a
...
export function storeWith(
  backing: DeferralStore,
  overrides: Partial<DeferralStore>,
): DeferralStore {
