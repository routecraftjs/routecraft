...
const mockMailboxOpen = mock();
const mockConnect = mock();
const mockLogout = mock();
const mockClose = mock();
const mockMessageFlagsAdd = mock();
const mockMessageFlagsRemove = mock();
const mockMessageMove = mock();
const mockMessageCopy = mock();
const mockMessageDelete = mock();
const mockAppend = mock();
const mockIdle = mock();
const mockSendMail = mock();

const mockImapFlowConstructor = mock();
...
mock.module("mailparser", () => ({
  simpleParser: mock().mockResolvedValue({
    text: "Hello world",
