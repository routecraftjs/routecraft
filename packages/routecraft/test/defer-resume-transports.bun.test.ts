...
import { deferring } from "./helpers/deferral.ts";
...
describe("defer and resume across transports", () => {
   ...
   */
  test("http() answers 202 with the Deferred body", async () => {
    let port = 0;
    t = await testContext()
      .on(
