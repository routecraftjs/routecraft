...
- [#755](https://github.com/routecraftjs/routecraft/pull/755) [`46af6ce`](https://github.com/routecraftjs/routecraft/commit/46af6ce4628c813b4ea2afce164c379b50d77a4e) Thanks [@ex0b1t](https://github.com/ex0b1t)! - `craft acp` reconnects when the instance behind it restarts ([#754](https://github.com/routecraftjs/routecraft/issues/754)).
  ...
  The bridge drops a conversation only when the instance answers its resume with the protocol's not-found code ([#756](https://github.com/routecraftjs/routecraft/issues/756)). A resume refused for any other reason, an instance whose store is busy among them, keeps the conversation and says so on standard error, and the next reconnection tries it again: the conversation may well still exist, and dropping it would lose the person's work on a false premise.
